...
>(({ className, isActive, ...props }, ref) => (
  <a
    ...
    className={cn(
      "rounded-sm inline-flex h-10 w-10 items-center justify-center border-2 border-black bg-white text-sm font-bold transition-all hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-none dark:hover:shadow-none",
      isActive
